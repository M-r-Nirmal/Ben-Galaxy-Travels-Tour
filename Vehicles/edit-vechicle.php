...
<body>
    <div id="wrapper">
        ...
        <div class="container-fluid body-section container">
            <div class="row">
                <div class="col-md-12">
                    <h2><i class="fa fa-plus-square"></i> Edit Vehicles<small> Don't Forget To Insert Images Again</small></h2>

                    <?php
                    require_once('db.php');
                    if (isset($_GET['id'])) {
                        $t_id = $_GET['id'];
                        $q = "SELECT * FROM vtype WHERE vtype.id = $t_id";
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $q = "SELECT * FROM vtype ORDER BY vtype.id DESC LIMIT 1";
                        $r = mysqli_query($con, $q);
                        ...
                        if (empty($title) or empty($post_data) or empty($size) or empty($price) or empty($image1) or empty($image2) or empty($image3) or empty($image4)) {
                            ...
                            $insert_query = "INSERT INTO vtype (`id`,`title`,`description`,`size`,`price`,`image1`,`image2`,`image3`,`image4`) VALUES ($id,'$title','$post_data','$size','$price','$image1','$image2','$image3','$image4')";
                        ...
                        <div class="col-xs-12">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    ?>
                                    <input type="text" name="title" placeholder="Type Room Title Here" value="<?php if (isset($title)) {
                                                                                                                    echo $title;
                                                                                                                } ?>" class="form-control">
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="size" placeholder="Type Size Here (sq. feet)" value="<?php if (isset($title)) {
                                                                                                                                echo $size;
                                                                                                                            } ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="price" placeholder="Type Price Here (Taka)" value="<?php if (isset($title)) {
                                                                                                                            echo $price;
                                                                                                                        } ?>" class="form-control">
                                        </div>
                                    </div>
                                ...
                                <input type="submit" class="btn btn-primary" value="Edit vechicle" name="submit">
                            </form>
                        </div>
                    </div>
                </div>
