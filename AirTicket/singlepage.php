...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      <h1>MALDIVES ON BUDGET</h1>
     
      <img src="mals.jpg" class="responsive" alt="" width="800" height="450">
      <hr>
       <p>Airline seats are subject to availability, in case of unavailability a similar category airline may be offered. Hotels are subject to availability, in case of unavailability similar stared hotel will be given with prior notice. Minimum two Passengers need to be travel. It is compulsory that you email the copies of passports.</p>
