...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <img src="lony.jpg" class="responsive" alt="" width="800" height="450">
      <hr>
       <p>From famous French wines to delicious Italian gelato, you’ll taste more, see more and get closer to authentic local experiences on our Europe tour packages.
	   Ceyline Travels European tour packages let you create lasting memories of all the most well-loved Europe tour attractions,
	   at an affordable price, without the stress of planning and other hazels.</p>
