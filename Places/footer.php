...
<footer class="spacer">
        <div class="container">
            <div class="row">
                <div class="col-sm-5">
                    <h4>Ben Galaxy Travels & Tours</h4>
                    <p>F44,45 PEOPLESPARK SHOPPING COMPLEX,</p>
                    <p>COLOMBO-11</p>
                    <p>SRILANKA</p>
                </div>              
...
<div class="text-center copyright">Copyright (c) reserved by <a href="index.php">Ben Galaxy Travels & Tours</a></div>
