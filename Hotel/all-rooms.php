...
<?php require_once('header-admin.php');?>
        ...
        <div class="container-fluid body-section container">
            <div class="row">
                <div class="col-md-12">
                    <h2><i class="fa fa-plus-square"></i> All Hotels <small>Edit or Delete Hotel</small></h2>
                        ...
                        <div class="card-content table-responsive table-full-width">
                            <table class="table">
                                <thead class="text-danger">
                                    ...
                                    <th><center>Hotel Title</center></th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><center><a href="#?id=<?php echo $row['id']; ?>"><i class="fa fa-pencil"></i></a></center></td>
