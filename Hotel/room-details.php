...
<div class="room-features spacer">
  <div class="row">
    ...
    <h3><strong>Common Facilities</strong></h3>    
    <ul>
    ...
    <div class="col-sm-3 col-md-2">
      <div class="size-price">Size<span><?php echo $row['size']; ?></span></div>
    </div>
    <div class="col-sm-3 col-md-2">
...
<div class="col-sm-5 col-md-4 " a align="center" >
	<br>
	<br>
<h3><strong>Hotel Reservation</strong></h3>
    <?php
        require_once('db.php');
        $error = "";
        $color = "red";
