...
<?php require_once('header-admin.php');?>
        ...
        <div class="container-fluid body-section container">
            <div class="row">
                <div class="col-md-12">
                    <h2><i class="fa fa-plus-square"></i> Add Hotels <small>Add New Hotel</small></h2>
                        ...
                        <div class="col-xs-12">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="title">Hotel Site :*</label>
                                    <?php
                                    if(isset($msg)){
                                ...
                                <div class="form-group">
                                    <label for="title">Hotel Description:*</label>
                                ...
                                <input type="submit" class="btn btn-primary" value="Add Hotel" name="submit">
                            </form>
                        </div>
                    </div>
                </div>
